...
local system = {}
system.settings = {
    fg_normal = beautiful.bg_normal or "#232323",  --light black
    bg_normal = beautiful.fg_normal or "#999999",  --light white
    fg_focus = beautiful.fg_focus or "#ffffff",   --white
    bg_focus = beautiful.bg_focus or "#b9214f",    --red
    border_color = beautiful.bg_focus or "#b9214f",  --red
    border_width = 3,
    height = 50,
    width  = 100,
    font = "Sans 48"
