...
local theme_dir = home_dir .. "/.config/awesome/themes/japanese2"
...
theme.menu_submenu_icon = theme_dir.."/menu/submenu.png"
theme.menu_border_width = 3
theme.menu_border_color = theme.bg_normal
theme.menu_height = 14
theme.menu_width  = 100
-- Menu icons
theme.menu_awesome = theme_dir.."/menu/awesome.png"
theme.menu_apps = theme_dir.."/menu/apps.png"
theme.menu_info = theme_dir.."/menu/info.png"
theme.menu_terminal = theme_dir.."/menu/terminal.png"
theme.menu_reboot = theme_dir.."/menu/reboot.png"
theme.menu_shutdown = theme_dir.."/menu/shutdown.png"
theme.menu_logout = theme_dir.."/menu/logout.png"
theme.menu_accept = theme_dir.."/menu/accept.png"
theme.menu_cancel = theme_dir.."/menu/cancel.png"
theme.menu_lock = theme_dir.."/menu/lock.png"
...
theme.blingbling.calendar.info_cell_style.text_color = bright_white
